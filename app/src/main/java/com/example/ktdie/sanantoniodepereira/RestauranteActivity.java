...
public class RestauranteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new RestauranteActivity.SectionsPagerAdapter(getSupportFragmentManager());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.mPrincipal:
                intent = new Intent(RestauranteActivity.this, MainActivity.class);
                intent.putExtra("username",username);
                intent.putExtra("correo",correo);
                startActivity(intent);
                finish();
            ...
            case R.id.mRestaurantes:
               /* Se quede en el actividad, no hace nada*/
                break;

            case R.id.mBares:
                intent = new Intent(RestauranteActivity.this, DiscotecasActivity.class);
                intent.putExtra("username",username);
                intent.putExtra("correo",correo);
                startActivity(intent);
                finish();
